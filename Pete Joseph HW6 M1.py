#Peter Joseph HW6 Bouncing Balls Simulation Program
...
def createBalls(num_balls):
    ...
    for k in range(0, num_balls):
        ...
        new_ball.fillcolor(colors[k]) #.fillcolor(colors[k]) from .fillcolor('black')
        new_ball.speed(0)
        new_ball.penup()
...
num_balls = 3 #int(input('Enter number of balls in simulation: ')) #change this to 3
